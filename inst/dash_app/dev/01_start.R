...
golem::fill_desc(
  ...
  author_email = "@rseis.com.br", # Your Email
  repo_url = "https://github.com/hamilton-institute/PACKAGENAME" # The URL of the GitHub Repo (optional)
)
...
golem::use_favicon("https://raw.githubusercontent.com/hamilton-institute/assets/main/favicon.png") # path = "path/to/ico". Can be an online file.
